...
func NewRSASecurity(pubStr string) (rsa *rSASecurity, pubKeyErr error) {
	rsa = &rSASecurity{}
	pubKeyErr = rsa.Init(pubStr)
	return
}

func NewRSASecurityByFile(pubFile string, ifCache bool) (rsa *rSASecurity, pubKeyErr error) {
	rsa = &rSASecurity{}
	pubKeyErr = rsa.InitByFile(pubFile, ifCache)
	return
}

func (this *rSASecurity) Init(pubStr string) (pubkeyErr error) {
...
func (this *rSASecurity) InitByFile(pubFile string, ifCache bool) (pubkeyErr error) {
